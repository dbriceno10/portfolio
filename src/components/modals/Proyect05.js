        ...
        <React.Fragment>
            <div className="modal-internal-container">
                ...
                <div className="">
                    ...
                    <p>
                    A simple application, made with vanilla JavaScript, CSS and HTML, fully responsive, which consumes the api https://rickandmortyapi.com/. We will change the page bringing all the characters in the series and showing their data.<br />Technologies applied: HTML, CSS, JavaScript, Git/Github.
                    </p>
