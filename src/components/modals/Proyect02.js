        ...
        <React.Fragment>
            <div className="modal-internal-container">
                ...
                <div className="">
                    ...
                    <p>
                    A Single-page application, built with react js and bootstrap, fully responsive, which consumes the https://rickandmortyapi.com/ api. Brings the possibility of an infinite pseudo scroll bringing all the characters.<br />Technologies applied: HTML, CSS, JavaScrip, Git/Github, React JS, Bootstrap.
                    </p>
